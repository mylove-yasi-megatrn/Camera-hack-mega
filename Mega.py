...
print('\n')
print(green+'%37s' % '   Devoloped By : aryan megatrn')
print (f"""{red}  ________________________________________________                
 |>>>-----------------------------------------<<<|
 |>>>-----------------------------------------<<<|
{blue} |>>>         {green}[Rubika(@KALl_T3RMUX)]{blue}          <<<|
 |>>>—————————————————————————————————————————<<<|
 |>>>      {green}   Telegram aryan_megatrn {blue}         <<<|
{red} |>>>-----------------------------------------<<<|
{red} |>>>-----------------------------------------<<<|  
{red} —————————————————————————————————————————————————""")
